...
class RegionRe {
    ...
    public:
        ...
        * 
        */
        RegionRe(int _id ,cv::Point p, int ** tabShare, cv::Mat * imageOriginal, int _threshold = 20, float _coefSD = 1.8);
        ...
        */
        RegionRe& operator=(const RegionRe& r);
        ...
        */
        void operator+= (const RegionRe & r2);

        /** 
        * Define the operator < for the class Region
        */
        bool operator<(const RegionRe& other) const;
